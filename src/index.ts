...
export class Mpesaflow extends Core.APIClient {
   ...
   * @param {string} [opts.baseURL=process.env['MPESAFLOW_BASE_URL'] ?? https://api.example.com/v1] - Override the default base URL for the API.
...
export namespace Mpesaflow {
  ...
  export import TransactionRetrieveStatusResponse = API.TransactionRetrieveStatusResponse;
}
