...
export class Mpesaflow extends Core.APIClient {
   ...
   */
  constructor({ baseURL = Core.readEnv('MPESAFLOW_BASE_URL'), ...opts }: ClientOptions = {}) {
...
export namespace Mpesaflow {
  ...
  export import PaymentPaybillResponse = API.PaymentPaybillResponse;
  export import PaymentPaybillParams = API.PaymentPaybillParams;
